...
def fig7():
    ...
    n_train   = _load_n_train()
    K         = u_sorted.shape[0]
    table5    = pd.read_csv("table5_imf_statistics.csv")
...
# ─────────────────────────────────────────────────────────────────────────────
def fig10():
    t7 = pd.read_csv("table7_single_model_errors.csv")
    t8 = pd.read_csv("table8_decomp_model_errors.csv")
...
# ─────────────────────────────────────────────────────────────────────────────
def fig13():
    t11 = pd.read_csv("table11_decomp_trading.csv")
    t12 = pd.read_csv("table12_single_trading.csv")
...
# ─────────────────────────────────────────────────────────────────────────────
def fig_dm():
    if not os.path.exists("table9_dm_stats_numeric.csv"):
        print("  WARNING: table9_dm_stats_numeric.csv not found")
        return

    dm_stats = pd.read_csv("table9_dm_stats_numeric.csv", index_col=0)
    dm_p1sid = pd.read_csv("table9_dm_pvals_onesided.csv", index_col=0)
