...
silver_df  = pd.read_csv("financial_data/processed/silver_weekly.csv",
...
margin_df.to_csv("table13_margin_sweep.csv", index=False)
...
holding_df.to_csv("table14_holding_periods.csv", index=False)
...
quality_df.to_csv("table15_final_comparison.csv", index=False)
...
plt.tight_layout()
plt.savefig("fig11_interval_forecasts.png", dpi=300, bbox_inches='tight')
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("fig12_trading_strategy_illustration.png", dpi=300, bbox_inches='tight')
plt.close()
...
fig.suptitle('Trading Performance — MCX Silver Price',
             fontsize=13, fontweight='bold')
plt.tight_layout()
plt.savefig('fig13_trading_evaluation.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig('fig13b_equity_curves.png', dpi=300, bbox_inches='tight')
plt.close()
