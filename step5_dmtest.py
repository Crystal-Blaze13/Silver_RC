...
OUT_TABLE9 = "table9_dm_test.csv"
OUT_FIG    = "fig_dm_heatmap.png"
...
dm_stats.to_csv("table9_dm_stats_numeric.csv")
dm_p1sid.to_csv("table9_dm_pvals_onesided.csv")
dm_p2sid.to_csv("table9_dm_pvals_twosided.csv")
