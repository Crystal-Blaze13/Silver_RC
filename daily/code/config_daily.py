...
# GDELT CSV files (relative to daily/code/ folder)
GDELT_FILES = [
    "../../preprocessed_data/processed/bquxjob_178470f6_19d57f8b1bb.csv",  # 2015-02-18 → 2018-12-31
    "../../preprocessed_data/processed/bquxjob_12d5030e_19d57fb8d7d.csv",  # 2019-01-01 → 2022-12-31
    "../../preprocessed_data/processed/bquxjob_49489022_19d57fc378f.csv",  # 2023-01-01 → 2026-03-31
]
...
IMFS_FILE       = "../processed/imfs_daily.npy"
COMPLEXITY_FILE = "../processed/imf_complexity_daily.csv"
LASSO_PKL       = "../processed/lasso_selected_features_daily.pkl"
PREDICTIONS_PKL = "../processed/predictions_daily.pkl"
