...
Output:
    preprocessed_data/processed/master_daily_prices.csv
...
# ── Paths (run from the daily/code/ directory) ────────────────────────────────
BLOOMBERG_FILE    = "../../preprocessed_data/processed/RC DATA.xlsx"
RAW_DATA_DIR      = "../../preprocessed_data/processed"
PROCESSED_DATA_DIR = "../../preprocessed_data/processed"
YFINANCE_FILES = {
    "gold_usd": f"{RAW_DATA_DIR}/gold.csv",
    "brent":    f"{RAW_DATA_DIR}/brent_crude.csv",
}
TRENDS_FILE = "../../preprocessed_data/processed/trends_india.csv"
EPU_FILE    = f"{RAW_DATA_DIR}/India_Policy_Uncertainty_Data.xlsx"
GDELT_FILES = [
    "../../preprocessed_data/processed/bquxjob_178470f6_19d57f8b1bb.csv",
    "../../preprocessed_data/processed/bquxjob_12d5030e_19d57fb8d7d.csv",
    "../../preprocessed_data/processed/bquxjob_49489022_19d57fc378f.csv",
]
...
try:
    ...
    sys.exit(f"ERROR: {BLOOMBERG_FILE} not found in the daily folder.")
...
try:
    ...
    sys.exit("ERROR: trends_india.csv not found in the daily folder.")
...
for fpath in GDELT_FILES:
    if not os.path.exists(fpath):
        sys.exit(f"ERROR: GDELT file not found: {fpath}\n"
                 "All three GDELT CSVs must be present in the daily folder.")
