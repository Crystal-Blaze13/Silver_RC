...
Input:  imfs_daily_gold.npy, financial_data/processed/gold_daily.csv
Output: fig8_gold_approximate_entropy.png
        imf_complexity_daily_gold.csv  (used by steps 3–6)
...
OUT_FIG8  = "../results/figures/fig8_gold_approximate_entropy.png"
OUT_COMP  = "../data/imf_complexity_daily_gold.csv"
...
signal_array = gold_df.iloc[:, 0].values.astype(float)
...
ax1.set_title("Fig 8 — IMF Approximate Entropy (Daily MCX Gold)",
...
print(f"  {OUT_FIG8}")
print("=" * 60)
print("NEXT: python step3_lasso_daily_gold.py")