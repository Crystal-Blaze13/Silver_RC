...
(predictions_daily.pkl instead of predictions.pkl).

Input:  predictions_daily.pkl
Output: table9_dm_test.csv
        fig_dm_heatmap.png
...
with open("../data/predictions_daily.pkl", "rb") as f:
    data = pickle.load(f)
...
ax.set_title("DM Test Matrix — MCX Silver Forecasting (Daily)\n"
...
print(f"  {OUT_FIG}")
print("=" * 60)
print("NEXT: python step6_trading_daily.py")