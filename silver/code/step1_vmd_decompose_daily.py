...
Produces:
  ...
  imfs_daily.npy          ← used by steps 2–6
        silver/data/silver_daily.csv
        silver/data/n_train_daily.npy
...
OUT_IMFS   = "../data/imfs_daily.npy"
OUT_SILVER = "../data/silver_daily.csv"
OUT_NTRAIN = "../data/n_train_daily.npy"
